...
Download the macOS DMG or Windows portable ZIP from [GitHub Releases](https://github.com/rianlu/apk-compat-helper/releases).
...
| Windows | Windows 10 21H2+, x64 | Portable `.zip`, extract and run |
